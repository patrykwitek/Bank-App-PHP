			...
			<?php
				if(@$_SESSION['login'] == true && @$_GET['id']==true){
					...
					<form action='user_details.php?id=".$id."' method='post' class='form'>
						Wprowadź nowe hasło: <input type='password' name='psswd1'><br/>
						Wprowadź ponownie nowe hasło: <input type='password' name='psswd2'><br/>
						<input type='submit' name='chg_psswd' id='add_button' value='Zmień hasło'>
					</form>
					";
				}
			?>
